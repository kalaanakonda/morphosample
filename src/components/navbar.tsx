...
export function Navbar() {
  ...
  return (
    <nav className={cn(
      "fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-4 md:px-10 bg-white/40 backdrop-blur-md border-b border-primary/[0.03] transition-all duration-700 ease-out",
      ...
      <div className="flex items-center gap-8">
        ...
        <div className="hidden lg:flex items-center gap-6">
          <a href="#" className="flex items-center gap-1 text-xs font-medium text-primary/50 hover:text-primary transition-colors">
